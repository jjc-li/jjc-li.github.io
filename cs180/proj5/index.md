...
<section id="part1">
    ...
    <p>
        ...
        Although it fails to recover fine textures because the "jump" from pure noise to a clean image is too difficult, it captures the global structure (the tower shape). The result is better than bluring, but can we do better?
    </p>
    ...
    <p>
        Building upon the previous approach, we can simply do it many times! 
        The core philosophy of the new approach is that while reversing the entire noise process in one step is mathematically impossible (too much information is lost), reversing a <em>tiny</em> amount of noise is tractable. By breaking the denoising process into many small steps (iterative denoising), the model can gradually capture structure, refining a blurry blob into a sharp image. In this project, I implemented a strided sampling schedule, skipping steps to speed up inference while carefully reinjecting noise to maintain stochasticity.
    </p>
...
<section id="part1-7-2">
    ...
    <p>
        ...
        At each step of the denoising loop, we replace the "keep" pixels with the original image (plus appropriate noise for that step). This forces the model to generate new content only inside the mask, while ensuring it blends with the surroundings.
    </p>
...
<section id="part1-7-3">
    ...
    <h4>Campanile &rarr; "Snowy Village"</h4>
    <div class="grid" style="grid-template-columns: repeat(7, 1fr); gap: 5px;">
        <article class="card"><figure><img class="fit" src="data/campanile.jpg" alt="Original"><figcaption>Original</figcaption></figure></article>
    ...
    <h4>Custom 1 &rarr; "Snowy Village"</h4>
    <div class="grid" style="grid-template-columns: repeat(7, 1fr); gap: 5px;">
        <article class="card"><figure><img class="fit" src="data/test_im1.jpg" alt="Original"><figcaption>Original</figcaption></figure></article>
    ...
    <h4>Custom 2 &rarr; "Snowy Village"</h4>
    <div class="grid" style="grid-template-columns: repeat(7, 1fr); gap: 5px;">
        <article class="card"><figure><img class="fit" src="data/test_im2.jpg" alt="Original"><figcaption>Original</figcaption></figure></article>
...
<section id="partB-part1">
    ...
    <h4>1.2.3 Denoising Pure Noise</h3>
    <p>
...
<section id="partB-part2-class">
    <h3>2.4 Adding Class-Conditioning</h2>
    <p>
